...
Here's a refresher from *Alan Wake 2* where you must solve a system of equations to [access a locked container](https://www.youtube.com/watch?v=YodF3_v_Wn0):
...
```
% Substitute right-hand side of E3 (B3 * 2) into E1
E1 = subs(E1, B1, rhs(E3));

% Substitute right-hand side of E2 (B3 + 128) into E1
...
Watch the [video](https://www.youtube.com/watch?v=YodF3_v_Wn0) in the beginning of this section to confirm the protagonist is able to open the container by entering `496` in the code lock.
